...
public class Assignment1 {
    ...
    public static String inchesToMeters(double inches) {
        ...
        String result = (inches + " inches is " + m + " meters");
    ...
    public static String addDigits(int number) {
        ...
        int second = remains % 10;
        remains = remains / 10;
        int third = remains % 10;
        remains = remains / 10;
        int fourth = remains % 10;
        int sumDigits = first + second + third + fourth;
    ...
    public static String powers(int number) {
        ...
        int power_4 = number * number * number * number;
        String result = String.format("Square: %d\nCube: %d\nFourth power: %d", square, cube, power_4);
